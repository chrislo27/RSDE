...
class EndRemixEntity(id: String, name: String, deprecatedIDs: List<String>)
    : Datamodel("endEntity", id, name, deprecatedIDs)

class ShakeEntity(id: String, name: String, deprecatedIDs: List<String>)
    : Datamodel("shakeEntity", id, name, deprecatedIDs)

class TextureEntity(id: String, name: String, deprecatedIDs: List<String>)
